#!/usr/bin/env python
#Code.py 
#This is a midi remote script for the Code by Peter Nyboer, based on Ohm64 script by aumha
...
STANDALONE = True  # If this is false, certain functions (like clip-launching) will not be setup since it is assumed that another script is taking care of these functions
COLS = 8
ROWS = 4
